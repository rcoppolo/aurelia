...
if !has("gui_running")
  ...
  let s:window = "000000"
  let s:line = "3a3a3a"
  let s:selection = "d70087"
end

hi clear
syntax reset

let g:colors_name = "aurelia"
...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
  ...
  call <SID>X("Visual", s:background, s:selection, "bold")
  ...
  call <SID>X("markdownH1", s:blue, "", "")
  call <SID>X("markdownH2", s:blue, "", "")
  call <SID>X("markdownH3", s:blue, "", "")
  call <SID>X("markdownH4", s:blue, "", "")
  call <SID>X("markdownH5", s:blue, "", "")
  call <SID>X("markdownH6", s:blue, "", "")
  call <SID>X("markdownListMarker", s:purple, "", "")
  " call <SID>X("markdownBold", s:red, "", "")

  " Erlang
  call <SID>X("erlangKeyword", s:red, "", "")
  call <SID>X("erlangBIF", s:orange, "", "")
  call <SID>X("erlangOperator", s:red, "", "")

  " Elixir
  call <SID>X("elixirKeyword", s:red, "", "")
